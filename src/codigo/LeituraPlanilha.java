...
public class LeituraPlanilha {
    ...
    public void escritaPlanilha(String nomeArquivo, ArrayList<Pessoa> listaPessoas) {
        ...
        try {
            FileInputStream fileInputStream = new FileInputStream(new File("src/" + nomeArquivo).getAbsolutePath());
            ...
            FileOutputStream outFile = new FileOutputStream(new File(new File("src/" + nomeArquivo).getAbsolutePath()));
